...
bot = telebot.TeleBot('8762728024:AAG6G5EQH1dQwPeSKlZptetRxeglhwnOwj4')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 authorized Access!  It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @MR_UGESH")
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "You Are Authorized To Use This Command 😡."
